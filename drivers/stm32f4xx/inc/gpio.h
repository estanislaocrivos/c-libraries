...
#define PUPDR_VAL(mode)             \
    (GPIO_IS_PULL_UP(mode)   ? 1U : \
     GPIO_IS_PULL_DOWN(mode) ? 2U : \
                               0U)
...
#define GPIO_AFRL_BIT(mode, af, pin)    ((uint32_t)(GPIO_IS_AF(mode) ? (af) : 0U) << ((pin) * 4))
#define GPIO_AFRH_BIT(mode, af, pin)    ((uint32_t)(GPIO_IS_AF(mode) ? (af) : 0U) << (((pin) - 8) * 4))
...
#define GPIOA_AFRL_CONFIG \
    ( GPIO_AFRL_BIT(GPIO_A0, GPIO_A0_AF, 0) | GPIO_AFRL_BIT(GPIO_A1, GPIO_A1_AF, 1) \
    | GPIO_AFRL_BIT(GPIO_A2, GPIO_A2_AF, 2) | GPIO_AFRL_BIT(GPIO_A3, GPIO_A3_AF, 3) \
    | GPIO_AFRL_BIT(GPIO_A4, GPIO_A4_AF, 4) | GPIO_AFRL_BIT(GPIO_A5, GPIO_A5_AF, 5) \
    | GPIO_AFRL_BIT(GPIO_A6, GPIO_A6_AF, 6) | GPIO_AFRL_BIT(GPIO_A7, GPIO_A7_AF, 7))

#define GPIOA_AFRH_CONFIG \
    ( GPIO_AFRH_BIT(GPIO_A8,  GPIO_A8_AF,  8)  | GPIO_AFRH_BIT(GPIO_A9,  GPIO_A9_AF,  9)  \
    | GPIO_AFRH_BIT(GPIO_A10, GPIO_A10_AF, 10) | GPIO_AFRH_BIT(GPIO_A11, GPIO_A11_AF, 11) \
    | GPIO_AFRH_BIT(GPIO_A12, GPIO_A12_AF, 12) | GPIO_AFRH_BIT(GPIO_A13, GPIO_A13_AF, 13) \
    | GPIO_AFRH_BIT(GPIO_A14, GPIO_A14_AF, 14) | GPIO_AFRH_BIT(GPIO_A15, GPIO_A15_AF, 15))
...
#define GPIOB_AFRL_CONFIG \
    ( GPIO_AFRL_BIT(GPIO_B0, GPIO_B0_AF, 0) | GPIO_AFRL_BIT(GPIO_B1, GPIO_B1_AF, 1) \
    | GPIO_AFRL_BIT(GPIO_B2, GPIO_B2_AF, 2) | GPIO_AFRL_BIT(GPIO_B3, GPIO_B3_AF, 3) \
    | GPIO_AFRL_BIT(GPIO_B4, GPIO_B4_AF, 4) | GPIO_AFRL_BIT(GPIO_B5, GPIO_B5_AF, 5) \
    | GPIO_AFRL_BIT(GPIO_B6, GPIO_B6_AF, 6) | GPIO_AFRL_BIT(GPIO_B7, GPIO_B7_AF, 7))

#define GPIOB_AFRH_CONFIG \
    ( GPIO_AFRH_BIT(GPIO_B8,  GPIO_B8_AF,  8)  | GPIO_AFRH_BIT(GPIO_B9,  GPIO_B9_AF,  9)  \
    | GPIO_AFRH_BIT(GPIO_B10, GPIO_B10_AF, 10) | GPIO_AFRH_BIT(GPIO_B11, GPIO_B11_AF, 11) \
    | GPIO_AFRH_BIT(GPIO_B12, GPIO_B12_AF, 12) | GPIO_AFRH_BIT(GPIO_B13, GPIO_B13_AF, 13) \
    | GPIO_AFRH_BIT(GPIO_B14, GPIO_B14_AF, 14) | GPIO_AFRH_BIT(GPIO_B15, GPIO_B15_AF, 15))
...
#define GPIOC_AFRL_CONFIG \
    ( GPIO_AFRL_BIT(GPIO_C0, GPIO_C0_AF, 0) | GPIO_AFRL_BIT(GPIO_C1, GPIO_C1_AF, 1) \
    | GPIO_AFRL_BIT(GPIO_C2, GPIO_C2_AF, 2) | GPIO_AFRL_BIT(GPIO_C3, GPIO_C3_AF, 3) \
    | GPIO_AFRL_BIT(GPIO_C4, GPIO_C4_AF, 4) | GPIO_AFRL_BIT(GPIO_C5, GPIO_C5_AF, 5) \
    | GPIO_AFRL_BIT(GPIO_C6, GPIO_C6_AF, 6) | GPIO_AFRL_BIT(GPIO_C7, GPIO_C7_AF, 7))

#define GPIOC_AFRH_CONFIG \
    ( GPIO_AFRH_BIT(GPIO_C8,  GPIO_C8_AF,  8)  | GPIO_AFRH_BIT(GPIO_C9,  GPIO_C9_AF,  9)  \
    | GPIO_AFRH_BIT(GPIO_C10, GPIO_C10_AF, 10) | GPIO_AFRH_BIT(GPIO_C11, GPIO_C11_AF, 11) \
    | GPIO_AFRH_BIT(GPIO_C12, GPIO_C12_AF, 12) | GPIO_AFRH_BIT(GPIO_C13, GPIO_C13_AF, 13) \
    | GPIO_AFRH_BIT(GPIO_C14, GPIO_C14_AF, 14) | GPIO_AFRH_BIT(GPIO_C15, GPIO_C15_AF, 15))
...
#define GPIOH_MODER_CONFIG  (GPIO_MODER_BIT(GPIO_H0, 0) | GPIO_MODER_BIT(GPIO_H1, 1))
#define GPIOH_OTYPER_CONFIG (GPIO_OTYPER_BIT(GPIO_H0, 0) | GPIO_OTYPER_BIT(GPIO_H1, 1))
#define GPIOH_PUPDR_CONFIG  (GPIO_PUPDR_BIT(GPIO_H0, 0) | GPIO_PUPDR_BIT(GPIO_H1, 1))
#define GPIOH_AFRL_CONFIG   (GPIO_AFRL_BIT(GPIO_H0, GPIO_H0_AF, 0) | GPIO_AFRL_BIT(GPIO_H1, GPIO_H1_AF, 1))
