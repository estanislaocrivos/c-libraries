/**
 * @file
 * @brief PIC18-K42 I2C1 driver header file.
 */
...
extern const struct i2c_ops pic18_i2c1_ops;
...
/**
 * @brief Transmits data through the I2C1 interface.
 * @param self Pointer to the I2C port structure.
...
/**
 * @brief Receives data through the I2C1 interface.
 * @param self Pointer to the I2C port structure.
...
/**
 * @brief Transmits raw data through the I2C1 interface without register
 * addressing.
 * @param self Pointer to the I2C port structure.
 * @param tx_payload Pointer to the data to be transmitted.
 * @param tx_payload_size Size of the data to be transmitted in bytes.
...
/**
 * @brief Receives raw data through the I2C1 interface without register
 * addressing.
 * @param self Pointer to the I2C port structure.
 * @param rx_payload Pointer to the buffer where received data will be stored.
 * @param rx_payload_size Size of the data to be received in bytes.
