...
void test_retrieve_payload_incomplete_frames(void)
{
    uint8_t _rx_raw_buffer[128]   = {0};
    uint8_t _tx_frame_buffer[128] = {0};
    uint8_t _internal_buffer[128] = {0};
    ...
    const uint8_t frame[]
        = {0xAA, 0x04, 0x01, 0x02, 0x03, 0x04, 0x55, 0xAA, 0xAA, 0xAA, 0x02, 0x03,
           0x04, 0x55, 0x34, 0xAA, 0x04, 0x05, 0x06, 0x07, 0x08, 0x55, 0xCB};  // First frame lacks
                                                                               // CRC, next frame
                                                                               // should be
                                                                               // discarded, last
                                                                               // frame should be ok
...
//     const uint8_t frame[]
//         = {0xAA, 0x04, 0x01, 0x02, 0x03, 0x04, 0x55, 0xAA, 0xAA, 0xAA, 0xAA, 0x03,
//            0x04, 0x55, 0x34, 0xAA, 0x04, 0x05, 0x06, 0x07, 0x08, 0x55, 0xCB};  // First frame
//            lacks
//                                                                                // CRC, next frame
//                                                                                // should be
//                                                                                // discarded, last
